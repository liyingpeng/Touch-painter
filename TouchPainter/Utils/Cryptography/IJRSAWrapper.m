...
- (NSData *)rsaEncryptWithData:(NSData*)data usingPublicKey:(BOOL)yes server:(BOOL)isServer{
...
- (NSData *)encryptUsingServerPublicKeyWithData:(NSData *)data {
    return [self rsaEncryptWithData:data usingPublicKey:YES server:YES];
}

- (NSData *)encryptUsingPublicKeyWithData:(NSData *)data{
